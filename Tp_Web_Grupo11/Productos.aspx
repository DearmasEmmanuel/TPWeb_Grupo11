<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Productos.aspx.cs" Inherits="Tp_Web_Grupo11.WebForm2" %>
    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="mb-3">
                ...
                <a href="Default.aspx" cssclass="btn btn-primary">Cancelar</a>
            </div>
